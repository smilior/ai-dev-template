...
案件未定のため、以下は記入例と記入用テンプレートである。案件が決まり次第、テンプレート側の各項目を埋めて使う。用語は docs/03_glossary.md と一致させる。
...
## 各ストーリーの受け入れ条件
> ストーリーごとに Given/When/Then でシナリオを書く。正常系と異常系の両方を書き、そのままテスト項目に転記できる粒度にする。
